...
<div class="tracks-container">
    ...
    <div class="game-header">
        ...
        <div class="flex justify-center items-center gap-2 flex-wrap">
            <Button href={`/${$page.params.lang}/time-trials/${game}/leaderboard`} size='md' extra_classes="flex items-center">
            ...
            {#if $user && check_permission($user, permissions.validate_time_trial_proof)}
                <Button href={`/${$page.params.lang}/time-trials/${game}/validation`} color="blue" size='md' extra_classes="flex items-center">
