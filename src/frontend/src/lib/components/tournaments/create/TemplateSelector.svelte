  ...
  <Table data={templates} let:item={template}>
    ...
    <tr class="row">
      <td class="left">
        ...
        {:else}
          <a href="/{$page.params.lang}/tournaments/create?template_id={template.id}">
            {template.template_name}
          </a>
        {/if}
      </td>
