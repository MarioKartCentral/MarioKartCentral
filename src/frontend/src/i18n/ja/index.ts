...
const ja: Translation = {
  ...
  NOTIFICATION_CONTENT: {
    ...
    '25': 'あなたの名前変更申請が承認されました！',
    '26': 'あなたの名前変更申請は否認されました。',
    '27': '次の役職が付与されました {role|bold} !',
    '28': 'あなたの {role|bold} の役職が剥奪されました。',
  ...
  PLAYERS: {
    ...
    PROFILE: {
      ...
      PROFILE_EDIT_SUCCESS: 'プロフィールの編集に成功しました',
      PROFILE_EDIT_FAILED: 'プロフィールの編集に失敗しました',
      PLAYER_DETAILS: 'プレイヤーの詳細',
      DISPLAY_NAME: '表示名',
      SHOW_ON_PLAYER_LIST: 'Show on player list?',
      REQUEST_NAME_CHANGE: '名前変更を申請する',
      PENDING_NAME_CHANGE: '名前変更待ちの申請',
      REQUEST_NAME_CHANGE_FAILED: '名前変更申請に失敗しました',
      EDIT_PLAYER_FAILED: 'プレイヤーの編集に失敗しました',
  ...
  PLAYER_BAN: {
    ...
    COMMENT_ONLY_MODS: 'コメント (モデレーターのみ閲覧可能)',
    INDEFINITE: '無期限',
    NUMBER_OF_DAYS: '日数',
    SELECT_REASON: '理由を選択',
    BAN_PLAYER: 'プレイヤーをBan',
    EDIT_BAN: 'Banを編集',
    UNBAN: 'Ban解除',
    BANNED: 'Banned',
    UNBANNED: 'Unbanned',
    ...
    USER: 'User {userId}',
    THE_PLAYER_IS_ALREADY_BANNED: 'このプレイヤーは既にBanされています。',
    FROM_INITIAL_BAN_DATE: 'From initial ban date',
    LIST_OF_BANNED_PLAYERS: 'Banされたプレイヤー一覧',
    LIST_OF_HISTORICAL_BANS: '過去のBan一覧',
