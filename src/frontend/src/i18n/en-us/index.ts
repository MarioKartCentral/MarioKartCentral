...
const en_us: BaseTranslation = {
  ...
  TIME_TRIALS: {
    TITLE: 'Time Trials',
    DESCRIPTION: 'Browse Mario Kart time trial leaderboards and records across different games and tracks.',
    VIEW_TRACKS: 'View Tracks',
    TRACK_LEADERBOARD: 'Track Leaderboard',
    BACK_TO_TRACKS: 'Back to Tracks',
    BACK_TO_GAMES: 'Back to Games',
    ENGINE_CLASS: 'Engine Class',
    NO_RECORDS: 'No records found for this track.',
