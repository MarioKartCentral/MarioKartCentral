...
const en_us: BaseTranslation = {
  ...
  TEAMS: {
    ...
    EDIT: {
      ...
      TEAM_ROLE_REMOVE_CONFIRM: 'Are you sure you want to remove the {team_role:string} role from {player_name:string}?',
  ...
  TOURNAMENTS: {
    ...
    REGISTRATIONS: {
      ...
      SELECT_LESS_PLAYERS: 'This tournament\'s max squad size is {max_squad_size:number} players, please remove at least {count:number} players.',
