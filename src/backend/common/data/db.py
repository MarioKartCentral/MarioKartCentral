...
class DBWrapper():
    def __init__(self, db_path, reset_db, admin_email, admin_pw):
    ...
    async def init(self):
        ...
        async with self.connect() as db:
            ...
            await db.execute("INSERT INTO users(id, email, password_hash) VALUES (0, ?, ?) ON CONFLICT DO NOTHING", (self.admin_email, pw_hasher.hash(str(self.admin_pw))))
