...
async def create_post(request: Request, body: CreateEditPostRequestData) -> JSONResponse:
    ...
    return JSONResponse(
        {"id": post_id},
        status_code=201,
        headers={"Location": f"/api/posts/{post_id}"},
    )
...
async def create_series_post(request: Request, body: CreateEditPostRequestData) -> JSONResponse:
    ...
    return JSONResponse(
        {"id": post_id},
        status_code=201,
        headers={"Location": f"/api/tournaments/series/{series_id}/posts/{post_id}"},
    )
...
async def create_tournament_post(request: Request, body: CreateEditPostRequestData) -> JSONResponse:
    ...
    return JSONResponse(
        {"id": post_id},
        status_code=201,
        headers={"Location": f"/api/tournaments/{tournament_id}/posts/{post_id}"},
    )
...
routes: list[Route] = [
    ...
    Route(
        "/api/tournaments/series/{series_id:int}/posts",
        create_series_post,
        methods=["POST"],
    ),
    Route(
        "/api/tournaments/series/{series_id:int}/posts/{post_id:int}",
        view_post,
    ),
    Route(
        "/api/tournaments/series/{series_id:int}/posts/{post_id:int}",
    ...
    Route(
        "/api/tournaments/{tournament_id:int}/posts",
        create_tournament_post,
        methods=["POST"],
    ),
    Route("/api/tournaments/{tournament_id:int}/posts/{post_id:int}", view_post),
    Route(
        "/api/tournaments/{tournament_id:int}/posts/{post_id:int}",
        edit_tournament_post,
        methods=["PATCH"],
    ),
]
