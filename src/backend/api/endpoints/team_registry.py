...
from common.data.models import (CreateTeamRequestData, EditTeamRequestData, CreateRosterRequestData, EditRosterRequestData, InviteRosterPlayerRequestData, AcceptRosterInviteRequestData, DeclineRosterInviteRequestData)
...
routes: list[Route] = [
    ...
    Route('/api/registry/teams/edit', edit_team, methods=['POST']),
