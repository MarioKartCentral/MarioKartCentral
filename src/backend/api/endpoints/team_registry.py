...
async def create_team(request: Request, body: CreateTeamRequestData) -> JSONResponse:
    ...
    return JSONResponse(
        {"id": team_id},
        status_code=201,
        headers={"Location": f"/api/registry/teams/{team_id}"},
    )
    ...
    async def notify():
        ...
        await handle(
            DispatchNotificationCommand(
                user_ids,
                notifications.STAFF_TEAM_EDIT,
                {"team_name": team_name},
                f"/registry/teams/profile?id={body.team_id}",
...
async def approve_team(request: Request) -> JSONResponse:
    async def notify():
        ...
        await handle(
            DispatchNotificationCommand(
                user_ids,
                notifications.TEAM_APPROVED,
                {"team_name": team_name},
                f"/registry/teams/profile?id={team_id}",
    ...
    return JSONResponse(
        ...
        background=BackgroundTask(notify),
    )
...
async def deny_team(request: Request) -> JSONResponse:
    ...
    await handle(command)
    return JSONResponse(
        {"team_id": team_id, "approval_status": "denied"},
        background=BackgroundTask(notify),
    )
...
async def approve_team_edit_request(request: Request, body: ApproveTeamEditRequestData) -> JSONResponse:
    async def notify():
        ...
        await handle(
            DispatchNotificationCommand(
                user_ids,
                notifications.TEAM_CHANGE_ACCEPTED,
                {"team_name": data.team_name},
                f"/registry/teams/profile?id={data.team_id}",
                notifications.SUCCESS,
            )
        )
...
async def deny_team_edit_request(request: Request, body: DenyTeamEditRequestData) -> JSONResponse:
    async def notify():
        ...
        await handle(
            DispatchNotificationCommand(
                user_ids,
                notifications.TEAM_CHANGE_DENIED,
                {"team_name": data.team_name},
                f"/registry/teams/profile?id={data.team_id}",
                notifications.WARNING,
            )
...
async def edit_roster(request: Request, body: EditRosterRequestData) -> JSONResponse:
    async def notify():
        ...
        await handle(
            DispatchNotificationCommand(
                user_ids,
                notifications.STAFF_ROSTER_EDIT,
                content_args,
                f"/registry/teams/profile?id={body.team_id}",
                notifications.WARNING,
            )
...
async def approve_roster_edit_request(request: Request, body: EditRosterChangeRequestData) -> JSONResponse:
    async def notify():
        data = await handle(
            GetNotificationTeamRosterDataFromRosterEditRequestCommand(body.request_id)
        ...
        await handle(
            DispatchNotificationCommand(
                user_ids,
                notifications.ROSTER_CHANGE_ACCEPTED,
                content_args,
                f"/registry/teams/profile?id={data.team_id}",
                notifications.SUCCESS,
            )
...
async def deny_roster_edit_request(request: Request, body: EditRosterChangeRequestData) -> JSONResponse:
    async def notify():
        ...
        await handle(
            DispatchNotificationCommand(
                user_ids,
                notifications.ROSTER_CHANGE_DENIED,
                content_args,
                f"/registry/teams/profile?id={data.team_id}",
                notifications.WARNING,
            )
...
async def accept_invite(request: Request, body: AcceptRosterInviteRequestData) -> Response:
    async def notify():
        ...
        await handle(
            DispatchNotificationCommand(
                user_ids,
                notifications.TEAM_INVITE_ACCEPTED,
                content_args,
                f"/registry/players/profile?id={request.state.user.player_id}",
                notifications.SUCCESS,
            )
        )
...
async def leave_team(request: Request, body: LeaveRosterRequestData) -> Response:
    async def notify():
        ...
        player_name = await handle(
            GetPlayerNameCommand(
                player_id,
            )
        )
        data = await handle(GetNotificationTeamRosterDataCommand(body.roster_id))
        ...
        await handle(
            DispatchNotificationCommand(
                user_ids,
                notifications.TEAM_PLAYER_LEFT,
                content_args,
                f"/registry/players/profile?id={player_id}",
                notifications.WARNING,
            )
        )
    ...
    async def notify():
        ...
        if player_user_id is not None:
            ...
            await handle(
                DispatchNotificationCommand(
                    [player_user_id],
                    notifications.STAFF_APPROVE_TRANSFER,
                    content_args,
                    f"/registry/teams/profile?id={data.team_id}",
                    notifications.SUCCESS,
                )
        ...
        await handle(
            DispatchNotificationCommand(
                user_ids,
                notifications.TEAM_TRANSFER_ACCEPTED,
                content_args,
                f"/registry/players/profile?id={data.player_id}",
                notifications.SUCCESS,
            )
        )
    ...
    async def notify():
        ...
        if player_user_id is not None:
            ...
            await handle(
                DispatchNotificationCommand(
                    [player_user_id],
                    notifications.STAFF_DENY_TRANSFER,
                    content_args,
                    f"/registry/teams/profile?id={data.team_id}",
                    notifications.WARNING,
                )
        ...
        await handle(
            DispatchNotificationCommand(
                user_ids,
                notifications.TEAM_TRANSFER_DENIED,
                content_args,
                f"/registry/players/profile?id={data.player_id}",
                notifications.WARNING,
            )
    ...
    async def notify():
        ...
        await handle(
            DispatchNotificationCommand(
                ...
                notifications.TEAM_TRANSFER_ACCEPTED,
                content_args,
                f"/registry/players/profile?id={body.player_id}",
                notifications.SUCCESS,
            )
        )
...
async def mod_kick_player(request: Request, body: KickPlayerRequestData) -> JSONResponse:
    async def notify():
        ...
        await handle(
            DispatchNotificationCommand(
                team_leader_ids,
                notifications.STAFF_KICK_PLAYER,
                content_args,
                f"/registry/teams/profile?id={body.team_id}",
                notifications.WARNING,
            )
...
async def approve_roster(request: Request) -> JSONResponse:
    ...
    await handle(command)
    return JSONResponse(
        {"id": roster_id, "approval_status": "approved"},
        background=BackgroundTask(notify),
    )
...
async def deny_roster(request: Request) -> JSONResponse:
    ...
    await handle(command)
    return JSONResponse(
        {"id": roster_id, "approval_status": "denied"},
        background=BackgroundTask(notify),
    )
...
routes: list[Route] = [
    ...
    Route(
        "/api/registry/teams/{team_id:int}/approve",
        approve_team,
        methods=["POST"],
    ),  # dispatches notification
    Route("/api/registry/teams/{team_id:int}/deny", deny_team, methods=["POST"]),  # dispatches notification
    Route(
        "/api/registry/teams/requestChange",
        request_edit_team,
        methods=["POST"],
    ),
    Route(
        "/api/registry/teams/approveChange",
        approve_team_edit_request,
        methods=["POST"],
    ),  # dispatches notification
    Route(
        "/api/registry/teams/denyChange",
        deny_team_edit_request,
        methods=["POST"],
    ),  # dispatches notification
    ...
    Route(
        "/api/registry/teams/requestCreateRoster",
        request_create_roster,
        methods=["POST"],
    ),
    ...
    Route(
        "/api/registry/teams/requestRosterChange",
        request_edit_roster,
        methods=["POST"],
    ),
    Route(
        "/api/registry/teams/approveRosterChange",
        approve_roster_edit_request,
        methods=["POST"],
    ),  # dispatches notification
    Route(
        "/api/registry/teams/denyRosterChange",
        deny_roster_edit_request,
        methods=["POST"],
    ),  # dispatches notification
    ...
    Route(
        "/api/registry/teams/forceDeleteInvite",
        mod_delete_invite,
        methods=["POST"],
    ),
    ...
    Route(
        "/api/registry/teams/approveTransfer",
        approve_transfer,
        methods=["POST"],
    ),  # dispatches notification
    ...
    Route(
        "/api/registry/teams/forceTransferPlayer",
        force_transfer_player,
        methods=["POST"],
    ),  # dispatches notification
    Route(
        "/api/registry/teams/editTeamMemberInfo",
        edit_team_member_info,
        methods=["POST"],
    ),
    Route("/api/registry/teams/kickPlayer", kick_player, methods=["POST"]),  # dispatches notification
    Route(
        "/api/registry/teams/forceKickPlayer",
        mod_kick_player,
        methods=["POST"],
    ),  # dispatches notification
    ...
    Route(
        "/api/registry/teams/{team_id:int}/approveRoster/{rosterId:int}",
        approve_roster,
        methods=["POST"],
    ),  # dispatches notification
    Route(
        "/api/registry/teams/{team_id:int}/denyRoster/{rosterId:int}",
        deny_roster,
        methods=["POST"],
    ),  # dispatches notification
    ...
    Route(
        "/api/registry/teams/{team_id:int}/rosterEditRequests/{rosterId:int}",
        roster_edit_history,
    ),
    Route("/api/registry/teams/merge", merge_teams, methods=["POST"]),
    Route(
        "/api/registry/teams/toggleBaggerClause",
        toggle_bagger,
        methods=["POST"],
    ),
]
