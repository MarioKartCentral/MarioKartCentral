...
from api.endpoints import authservice, roleservice, s3service, userservice, tournaments, tournament_registration, player_registry, team_registry, user_settings, notifications
